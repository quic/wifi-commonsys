...
This project is licensed under the [BSD 3-Clause Clear License](https://spdx.org/licenses/BSD 3-Clause Clear License.html). For the full license text, please refer to the [LICENSE](LICENSE) file in this repository.